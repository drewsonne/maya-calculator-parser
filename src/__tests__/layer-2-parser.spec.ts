  ...
  describe('should parse operators', () => {
    ...
    operations.forEach((pattern) => {
      ...
      it(`${rawText} -> ${expectedTokens}`, () => {
        ...
        const layer1Tokens = new Layer0Parser().parseRaw(rawText).processLayer1().processLayer2()
  ...
  describe('should parse calendar rounds', () => {
    ...
    crs.forEach((pattern) => {
      ...
      it(`${rawString} -> ${expectedTokens}`, () => {
        ...
        const tokenised = new Layer0Parser().parseRaw(rawString).processLayer1().processLayer2()
  ...
  describe('should parse long counts', () => {
    const looseLongCounts: [string, IToken[]][] = [
      ...
      [
        "10.10\n9.9",
        [
          LongCountToken.parse([NT(10), PT, NT(10)]), LET,
          LongCountToken.parse([NT(9), PT, NT(9)]), LET
        ]
      ],
      [
        ' 8. 7. 6. 5. 4.17. 2. 1',
