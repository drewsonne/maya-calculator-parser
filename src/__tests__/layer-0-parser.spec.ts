...
describe('layer-0 parser', () => {
    ...
    const looseFullLines: [string, IToken[]][] = [
      [
        ...
        [
          ...
          ST, CT('Hello world, this is a comment'),
          LET
        ]
      ],
      [
  ...
  describe('should parse full dates', () => {
    const looseFullDates: [string, IToken[]][] = [
      [
        '1Ok * * 9.*.10.10.10',
        [NT(1), WT('Ok'), ST, WCT, ST, WCT, ST, NT(9), PT, WCT, PT, NT(10), PT, NT(10), PT, NT(10), LET]
      ]
    ]
  ...
  describe('should parse calendar rounds', () => {
    const looseCrs: [string, IToken[]][] = [
      ['4 Ajaw 8 Kumk\'u', [NT(4), ST, WT('Ajaw'), ST, NT(8), ST, WT('Kumk\'u'), LET]],
      ['3 Kawak **', [NT(3), ST, WT('Kawak'), ST, WCT, WCT, LET]],
      ['* Ajaw 8 Kumk\'u', [WCT, ST, WT('Ajaw'), ST, NT(8), ST, WT('Kumk\'u'), LET]],
      ['6 Manik\' 5 Mol', [NT(6), ST, WT('Manik\''), ST, NT(5), ST, WT('Mol'), LET]],
      ['6Manik\' 5Mol', [NT(6), WT('Manik\''), ST, NT(5), WT('Mol'), LET]],
      ['* * 12 Mol', [WCT, ST, WCT, ST, NT(12), ST, WT('Mol'), LET]],
      ['3 Kawak 7 Kumk\'u', [NT(3), ST, WT('Kawak'), ST, NT(7), ST, WT('Kumk\'u'), LET]],
      ['4 Ajaw 8 Kumk\'u', [NT(4), ST, WT('Ajaw'), ST, NT(8), ST, WT('Kumk\'u'), LET]],
      ['** 13 Xul', [WCT, WCT, ST, NT(13), ST, WT('Xul'), LET]],
      ['6 Kimi * * ', [NT(6), ST, WT('Kimi'), ST, WCT, ST, WCT, ST, LET]],
      ['5 Kimi 4 Mol', [NT(5), ST, WT('Kimi'), ST, NT(4), ST, WT('Mol'), LET]],
      ['* Chikchan 3 Mol', [WCT, ST, WT('Chikchan'), ST, NT(3), ST, WT('Mol'), LET]],
    ]
  ...
  describe('should parse long counts', () => {
    const dates: [string, IToken[]][] = [
      ['7.13', [NT(7), PT, NT(13), LET]],
      ['0.0.0.7.13', [NT(0), PT, NT(0), PT, NT(0), PT, NT(7), PT, NT(13), LET]],
      ['9.16.19.17.19', [NT(9), PT, NT(16), PT, NT(19), PT, NT(17), PT, NT(19), LET]],
      ["10.10\n9.9", [NT(10), PT, NT(10), LET, NT(9), PT, NT(9), LET]],
      [" 8. 7. 6. 5. 4.17. 2. 1", [
        ST, NT(8), PT,
        ST, NT(7), PT,
        ST, NT(6), PT,
      ...
      ['*.*.*.7.13', [WCT, PT, WCT, PT, WCT, PT, NT(7), PT, NT(13), LET]]
    ]
